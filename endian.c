...
char changeEndian( void* source, size_t size, char curEndian, char nxtEndian )
{
  ...
  switch ( curEndian )
  {
    case 'L': case 'P': case 'B': break;
    case 'l': curEndian = 'L'; break;
    case 'b': curEndian = 'B'; break;
    case 'm': case 'M':
    case 'p': curEndian = 'M'; break;
    default: return 'E';
  }
  switch ( nxtEndian )
  {
    case 'L': case 'P': case 'B': break;
    case 'l': nxtEndian = 'L'; break;
    case 'b': nxtEndian = 'B'; break;
    case 'm': case 'M':
    case 'p': nxtEndian = 'M'; break;
    default: return 'E';
  }
  if ( !size )
    return curEndian + 'S';
